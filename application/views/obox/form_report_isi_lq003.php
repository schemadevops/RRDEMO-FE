    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            ...
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Obox /</span>
                Form Report / Form LQ003 -
                Nasabah dengan Dana Masuk Terbesar</h4>
            <!-- Responsive Table -->
            <div class="card">
                    ...
                    <table id="table-res" class="table dt-responsive">
                        <thead>
                            <tr class="text-nowrap">
                                ...
                                <th>"Jenis DPK/Simpanan dari Bank Lain
                                    Placement from other Banks in BPR"</th>
                                <th>Nominal</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td>1320000021</td>
                                <td>
                                    <a href="<?= base_url('obox/form_report_edit_lq003'); ?>" class="btn rounded-pill btn-primary"><i class='bx bx-edit-alt'></i> Edit
                                    </a>
                                </td>
                            </tr>
                            <tr>
