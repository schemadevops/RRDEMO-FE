...
<head>
    ...
    <title>Under Maintenance| Reguratory Report</title>
...
<body style="background-color: #CAF1EF;">
    ...
    <div>
        <div class="misc-wrapper">
            ...
            <div class="mt-4">
                <img src="<?= base_url('assets/'); ?>assets/img/illustrations/girl-doing-yoga-light.png" alt="girl-doing-yoga-light" width="500" class="img-fluid" data-app-dark-img="illustrations/girl-doing-yoga-dark.png" data-app-light-img="illustrations/girl-doing-yoga-light.png" />
            </div>
        </div>
    </div>
    <!-- /Under Maintenance -->
