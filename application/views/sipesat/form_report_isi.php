        ...
        <div class="row">
            ...
            <div class="card">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $key->identitas_lainnya; ?></td>
                                    <td><?= $key->no_cif; ?></td>
                                    <td><?= $key->npwp; ?></td>
                                    <td><?= date('d-m-Y', strtotime($key->createdAt)); ?></td>
                                    <td>
                                        <a href="<?= base_url('sipesat/form_report_edit/' . $key->id); ?>" class="btn rounded-pill btn-primary"><i class='bx bx-edit-alt'></i> Edit
                                        </a>
                                    </td>
                                </tr>
                            <?php
                ...
                <div class="row mt-3 mb-3">
                    <div class="col-md-3">
                        <a href="<?= base_url('sipesat/exportDataToTxt'); ?>" class="btn rounded-pill btn-primary my-2">Export to Txt
                        </a>
                    </div>
                    <div class="col-md-5">
                        ;&nbsp
...
<script>
    ...
    function save_periode() {
        ...
        url = "<?php echo site_url('sipesat/ajax_periode') ?>";
