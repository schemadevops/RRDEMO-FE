                ...
                <div class="container mb-3">
                    <form id="form">
                        <div class="row mb-3 mt-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="include_text" name="include_text" value="<?= $api_hasil->include_text; ?>" readonly />
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="nm_rekening" id="nm_rekening" class="form-select">
                                    <option value="Tabungan Berjangka">Tabungan Berjangka</option>
                                    <optgroup label="Deposito"></optgroup>
                                    <option value="a.Sudah Jatuh Tempo">a.Sudah Jatuh Tempo</option>
                                    <option value="b. Belum Jatuh Tempo">b. Belum Jatuh Tempo</option>
                                    <optgroup label="Simpanan dari bank lain"></optgroup>
                                    <option value="a.Sudah Jatuh Tempo">a.Sudah Jatuh Tempo</option>
                                    <option value="b. Belum Jatuh Tempo">b. Belum Jatuh Tempo</option>
                                    <optgroup label="Pinjaman yang diterima dari Bank"></optgroup>
                                    <option value="a.Sudah Jatuh Tempo">a.Sudah Jatuh Tempo</option>
                                    <option value="b. Belum Jatuh Tempo">b. Belum Jatuh Tempo</option>
                                    <optgroup label="Pinjaman yang diterima dari Pihak Ketiga Bukan Bank">
                                    </optgroup>
                                    <option value="a.Sudah Jatuh Tempo">a.Sudah Jatuh Tempo</option>
                                    <option value="b. Belum Jatuh Tempo">b. Belum Jatuh Tempo</option>
                                    <optgroup label="Lainnya">
                                    </optgroup>
                                    <option value="Utang Bunga Lainnya">Utang Bunga Lainnya</option>
                                    <option value="Utang Pajak">Utang Pajak</option>
                                    <option value="Liabilitas Imbalan Kerja">Liabilitas Imbalan Kerja</option>
                                    <option value="Liabilitas Sewa Pembiayaan">Liabilitas Sewa Pembiayaan</option>
                                    <option value="Taksiran pajak penghasilan">Taksiran pajak penghasilan</option>
                                    <option value="Pendapatan yang ditangguhkan">Pendapatan yang ditangguhkan</option>
                                    <option value="Liabilitas Pajak Tangguhan">Liabilitas Pajak Tangguhan</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="sandi_pos" name="sandi_pos" value="<?= $api_hasil->sandi_pos; ?>" readonly />
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="hidden" class="form-control" id="id_1400" name="id_1400" value="<?= $api_hasil->id; ?>" />
                            </div>
                        </div>
                        <div class="row justify-content-end py-3">
                            <div class="col-sm-10">
                                <button type="button" id="btnEdit" onclick="edit()" class="btn btn-primary">Edit</button>
                                <a href="<?= base_url('apollo/form_report_isi_1400') ?>" class="btn btn-warning">Kembali</a>
                            </div>
                        </div>
                    </form>
...
<script>
    $(document).ready(function() {
        $('#table-res').DataTable({
            ...
            buttons: [{
                    extend: 'copyHtml5',
                    messageTop: '[LOG Edit]APOLO - Form 14.00 - Other Liability Details',
                    exportOptions: {
        ...
        $("#nm_rekening option[value='<?= $api_hasil->nm_rekening; ?>']").prop('selected', true);
    });
    ...
    function edit() {
        ...
        url = "<?php echo site_url('apollo/ajax_edit_1400') ?>";
