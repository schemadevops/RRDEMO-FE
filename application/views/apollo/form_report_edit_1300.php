                ...
                <div class="container mb-3">
                    <form id="form">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="jenis_bank" id="jenis_bank" class="form-select">
                                    ...
                                    <option value="832">832 (BUMN Lainnya)</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="sandi_bank" id="sandi_bank" class="form-select">
                                    <option value="602000">602000 (PT. BPR Citradana Rahayu)</option>
                                    <option value="602541">602541 (PT BPR Dana Nagoya)</option>
                                    <option value="002">002 (BANK RAKYAT INDONESIA)</option>
                                    <option value="601305">601305 (PT. BPR Berfasi Raharja)</option>
                                    <option value="602622">602622 (PT BPR Nustria Mitra Abadi)</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="jenis" id="jenis" class="form-select">
                                    <option value="01">01 (Tabungan)</option>
                                    <option value="02">02 (Deposito)</option>
                                    <option value="11">11 (Tabungan khusus dari BPR lain untuk
                                        penanggulangan permasalahan likuditas)</option>
                                    <option value="12">12 (Deposito khusus dari BPR lain untuk rangka
                                        penanggulangan permasalahan likuditas)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="nominal_blokir" name="nominal_blokir" value="<?= $api_hasil->nominal_diblokir; ?>" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Alasan Diblokir</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="alasan_blokir" name="alasan_blokir" value="<?= $api_hasil->alasan_diblokir; ?>" />
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="hidden" class="form-control" id="id_1300" name="id_1300" value="<?= $api_hasil->id; ?>" />
                            </div>
                        </div>
                        <div class="row justify-content-end py-3">
                            <div class="col-sm-10">
                                <button type="button" id="btnEdit" onclick="edit()" class="btn btn-primary">Edit</button>
                                <a href="<?= base_url('apollo/form_report_isi_1300') ?>" class="btn btn-warning">Kembali</a>
                            </div>
                        </div>
                    </form>
...
<script>
    $(document).ready(function() {
        $('#table-res').DataTable({
            ...
            buttons: [{
                    extend: 'copyHtml5',
                    messageTop: '[LOG Edit]APOLO - Form 13.00 - List of Saving Account or Fix Deposit Account From Other Banks',
                    exportOptions: {
        ...
        $("#jenis_bank option[value='<?= $api_hasil->jenis_bank; ?>']").prop('selected', true);
    });
    ...
    function edit() {
        ...
        url = "<?php echo site_url('apollo/ajax_edit_1300') ?>";
