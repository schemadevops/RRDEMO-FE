                    ...
                    <table class="table table-striped table-bordered dt-responsive nowrap" id="table-res">
                        <thead>
                            <tr class="text-nowrap">
                                ...
                                <th rowspan="2">Tanggal Hapusbuku</th>
                                <th colspan="3">Saldo Pokok</th>
                                <th colspan="4">Tunggakan Bunga</th>
                                <th colspan="3">Agunan</th>
                                <th rowspan="2">Created At</th>
                                <th rowspan="2">Edit</th>
                            </tr>
                            <tr>
                                <td>Saat Hapus Buku</td>
                                <td>Akumulasi Tertagih</td>
                                <td>Per Posisi Laporan</td>
                                <td>Saat Hapus Buku</td>
                                <td>Akumulasi Tertagih</td>
                                <td>Akumulasi Tambahan Bunga Berjalan</td>
                                <td>Per Posisi Laporan</td>
                                <td>Jenis</td>
                                <td>Alamat</td>
                                <td>Nilai</td>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $key->jenis; ?></td>
                                    <td><?= $key->gol_debitor; ?></td>
                                    <td><?= $key->hubungan_bank; ?></td>
                                    <td><?= $key->tgl_hapus_buku; ?></td>
                                    <td><?= $key->sp_hapus_buku; ?></td>
                                    <td><?= $key->sp_akumlasi_tertagih; ?></td>
                                    <td><?= $key->sp_posisi_laporan; ?></td>
                                    <td><?= $key->tb_hapus_buku; ?></td>
                                    <td><?= $key->tb_akumalasi_tertagih; ?></td>
                                    <td><?= $key->tb_akumulasi_tambahan; ?></td>
                                    <td><?= $key->tb_posisi_laporan; ?></td>
                                    <td><?= $key->agunan_jenis; ?></td>
                                    <td><?= $key->agunan_alamat; ?></td>
                                    <td><?= $key->agunan_nilai; ?></td>
                                    <td><?= date('d-m-Y', strtotime($key->createdAt)); ?></td>
                                    <td>
                                        <a href="<?= base_url('apollo/form_report_edit_1500/' . $key->id); ?>" class="btn rounded-pill btn-primary"><i class='bx bx-edit-alt'></i>
                                        </a>
                                    </td>
                                </tr>
                            <?php };
