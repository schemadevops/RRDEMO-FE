    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            ...
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Apolo /</span>
                Form Report/ Form 15.00</h4>
            <!-- Responsive Table -->
            <div class="card">
                <h5 class="card-header">Form 15.00</h5>
                    ...
                    <table class="table table-striped table-bordered dt-responsive nowrap" id="table-res">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>100000</td>
                                <td>
                                    <a href="<?= base_url('apollo/form_report_edit_1500'); ?>" class="btn rounded-pill btn-primary"><i class='bx bx-edit-alt'></i>
                                    </a>
                                </td>
                            </tr>
                            <tr>
