            ...
            <div class="card">
                ...
                <div class="container mb-3">
                    <form id="form">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="jenis_agunan" id="jenis_agunan" class="form-select">
                                    <option value="01">01 (Emas perhiasan)</option>
                                    <option value="02">02 (Tanah dan/atau Bangunan)</option>
                                    <option value="03">03 (Resi gudang)</option>
                                    <option value="04">04 (Tempat usaha/los/kios/lapak/)</option>
                                    <option value="05">05 (Kendaraan bermotor/kapal/perahu bermotor/alat
                                        berat/mesin yang menjadi kesatuan dengan tanah)
                                    </option>
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Tanggal Pengambilalihan </label>
                            <div class="col-sm-10">
                                <input type="date" class="form-control" id="tgl_pengambialihan" name="tgl_pengambialihan" value="<?= date('Y-m-d', strtotime($api_hasil->tgl_pengambialihan)); ?>" />
                            </div>
                        </div>

                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Nilai Pengakuan Awal
                            </label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="nilai_pengakuan_awal" name="nilai_pengakuan_awal" value="<?= $api_hasil->nilai_pengakuan_awal; ?>" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Akumulasi Kerugian Penurunan Nilai
                            </label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="akumulasi_keruguan" name="akumulasi_keruguan" value="<?= $api_hasil->akumulasi_keruguan; ?>" />
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="hidden" class="form-control" id="id_0700" name="id_0700" value="<?= $api_hasil->id; ?>" />
                            </div>
                        </div>
                        <div class="row justify-content-end py-3">
                            <div class="col-sm-10">
                                <button type="button" id="btnEdit" onclick="edit()" class="btn btn-primary">Edit</button>
                                <a href="<?= base_url('apollo/form_report_isi_0700') ?>" class="btn btn-warning">Kembali</a>
                            </div>
                        </div>
                    </form>
...
<script>
    $(document).ready(function() {
        $('#table-res').DataTable({
            ...
            buttons: [{
                    extend: 'copyHtml5',
                    messageTop: '[LOG Edit]APOLO - Form 07.00 - List of Collatetal That Has Overtaken by BPR',
                    exportOptions: {
    ...
    function edit() {
        ...
        url = "<?php echo site_url('apollo/ajax_edit_0700') ?>";
