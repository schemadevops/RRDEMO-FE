            ...
            <div class="card">
                ...
                <div class="container mb-3">
                    <form id="form">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="klasifikasi" id="klasifikasi" class="form-select">
                                    <option value="1">1 (Tersedia untuk Dijual) </option>
                                    <option value="2">2 (Dimiliki Hingga Jatuh Tempo)</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Nominal yang dijaminkan</label>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Premium/Diskonto Belum
                                Diamortisasi</label>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Laba/Rugi Belum Direalisasi</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="laba_rugi" name="laba_rugi" value="<?= $api_hasil->laba_rugi; ?>" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Biaya Perolehan Diamortisasi/Nilai
                                Wajar</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="biaya_perolehan_diamortisasi" name="biaya_perolehan_diamortisasi" value="<?= $api_hasil->biaya_perolehan_diamortisasi; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="hidden" class="form-control" id="id_0400" name="id_0400" value="<?= $api_hasil->id; ?>" />
                            </div>
                        </div>
                        <div class="row justify-content-end py-3">
                            <div class="col-sm-10">
                                <button type="button" id="btnEdit" onclick="edit()" class="btn btn-primary">Edit</button>
                                <a href="<?= base_url('apollo/form_report_isi_0400') ?>" class="btn btn-warning">Kembali</a>
                            </div>
                        </div>
                    </form>
...
<script>
    $(document).ready(function() {
        $('#table-res').DataTable({
            ...
            buttons: [{
                    extend: 'copyHtml5',
                    messageTop: '[LOG Edit]APOLO - Form 04.00 - List of Securities',
                    exportOptions: {
        ...
        $("#klasifikasi option[value='<?= $api_hasil->klasifikasi; ?>']").prop('selected', true);
    });
    ...
    function edit() {
        ...
        url = "<?php echo site_url('apollo/ajax_edit_0400') ?>";
