                ...
                <div class="container mb-3">
                    <form>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="pilih" id="" class="form-select">
                                    <option value="00">1 (Tersedia untuk Dijual) </option>
                                    <option value="01">2 (Dimiliki Hingga Jatuh Tempo)</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="basic-default-company" value="55.54" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="date" class="form-control" id="basic-default-company" value="10000" />
                            </div>
                        </div>
                        <div class="row mb-3">
