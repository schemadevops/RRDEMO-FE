                ...
                <div class="container mb-3">
                    <form>
                        <div class="row mb-3 mt-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="basic-default-name" value="Nama A" />
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row">
                            <label class="col-sm-12 col-form-label text-center">Jabatan</label>
                            <hr>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="pilih" id="" class="form-select">
                                    ...
                                    <option value="02">02 (Pejabat Eksekutif)</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="date" class="form-control" id="basic-default-company" value="111111111111111" />
                            </div>
                        </div>

                        <div class="row">
                            <label class="col-sm-12 col-form-label text-center">Surat
                                Pengangkatan</label>
                            <hr>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-company">No.</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="basic-default-company" value="111111111111111" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="pilih" id="" class="form-select">
                                    <option value="110">00 (Tidak Menjabat)</option>
                                    <option value="120">01 (Ketua)</option>
                                    <option value="210">02 (Anggota)</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="pilih" id="" class="form-select">
                                    <option value="110">1 (Pengunduran diri)</option>
                                    <option value="120">2 (Pemberhentian)</option>
                                    <option value="120">3 (Meninggal dunia)</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Alasan Mengundurkan Diri/
                                Pemberhentian</label>
                            <div class="col-sm-10">
