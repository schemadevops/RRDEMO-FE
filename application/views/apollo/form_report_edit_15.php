                ...
                <div class="container mb-3">
                    <form id="form">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="jumlah_transaksi" name="jumlah_transaksi" value="<?= $api_hasil->jumlah_transaksi; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="hidden" class="form-control" id="id_0015" name="id_0015" value="<?= $api_hasil->id; ?>" />
                            </div>
                        </div>
                        <div class="row justify-content-end py-3">
                            <div class="col-sm-10">
                                <button type="button" id="btnEdit" onclick="edit()" class="btn btn-primary">Edit</button>
                                <a href="<?= base_url('apollo/form_report_isi_0015') ?>" class="btn btn-warning">Kembali</a>
                            </div>
                        </div>
                    </form>
...
<script>
    $(document).ready(function() {
        $('#table-res').DataTable({
            ...
            buttons: [{
                    extend: 'copyHtml5',
                    messageTop: '[LOG Edit]APOLO - Form 00.15 - Rincian Transaksi Terkait Penilaian Risiko TPPU Dan TPPT',
                    exportOptions: {
    ...
    function edit() {
        ...
        url = "<?php echo site_url('apollo/ajax_edit_0015') ?>";
