                ...
                <div class="container mb-3">
                    <form>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="pilih" id="" class="form-select" disabled>
                                    <option value="00">1. Transaksi melalui Jaringan Distribusi Tatap
                                        Muka</option>
                                    <option value="01">1.1 Melibatkan Perpindahan Dana</option>
                                    <option value="01">a. Dana Masuk</option>
