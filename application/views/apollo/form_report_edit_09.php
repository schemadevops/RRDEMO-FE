    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            ...
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Apolo /</span>
                Form Report/ Form 00.09</h4>
            <!-- Responsive Table -->
            <div class="card">
                <h5 class="card-header">Form 00.09</h5>
                <div class="container mb-3">
                    <form>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="pilih" id="" class="form-select">
                                    <option value="110">01 (Ya)</option>
                                    <option value="120">02 (Tidak)</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="basic-default-company" value="" />
                            </div>
                        </div>
