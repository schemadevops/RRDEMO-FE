                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $key->jumlah; ?></td>
                                    <td><?= $key->nominal_dijaminkan; ?></td>
                                    <td><?= $key->alasan_diblokir; ?></td>
                                    <td><?= $key->ppap_yang_terbentuk; ?></td>
                                    <td><?= $key->pendapatan_bunga_diteima; ?></td>
                                    <td><?= $key->pendapatan_bunga_penyelesaian; ?></td>
                                    <td><?= $key->status_bmpk; ?></td>
                                    <td><?= date('d-m-Y', strtotime($key->createdAt)); ?></td>
                                    <td>
                                        <a href="<?= base_url('apollo/form_report_edit_500/' . $key->id); ?>" class="btn rounded-pill btn-primary"><i class='bx bx-edit-alt'></i>
                                        </a>
                                    </td>
                                </tr>
                        </tbody>
...
<script>
    $(document).ready(function() {
        $('#table-res').DataTable({
            ...
            buttons: [{
                    extend: 'copyHtml5',
                    messageTop: 'APOLO - Form 05.00 - List of Placement in Other Banks',
                    exportOptions: {
