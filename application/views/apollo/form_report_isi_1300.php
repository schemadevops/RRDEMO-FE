                    ...
                    <table class="table table-striped table-bordered dt-responsive nowrap" id="table-res">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>602000 (PT. BPR Citradana Rahayu)</td>
                                ...
                                <td>100000</td>
                                <td>
                                    <a href="<?= base_url('apollo/form_report_edit_1300'); ?>" class="btn rounded-pill btn-primary"><i class='bx bx-edit-alt'></i>
                                    </a>
                                </td>
                            </tr>
                            <tr>
