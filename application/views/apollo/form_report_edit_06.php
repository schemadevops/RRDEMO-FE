                    ...
                    <form id="form">
                        <div class="row mb-3 mt-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-name">Jenis
                                Ekuitas</label>
                            <div class="col-sm-10">
                                <select name="jenis_ekuitas" id="jenis_ekuitas" class="form-select">
                                    <option value="01">01 (Dana)</option>
                                    <option value="02">02 (Tanah dan bangungan yang dapat di perhitungkan
                                        sebagai modal inti)</option>
                                    <option value="03">03 (Tanah dan bangungan yang tidak dapat di
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-company">Tanggal
                                Persetujuan</label>
                            <div class="col-sm-10">
                                <input type="date" class="form-control" id="tgl" name="tgl" value="<?= date('Y-m-d', strtotime($api_hasil->tanggal_persetujuan_ojk)); ?>" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-name">Jenis
                                Modal</label>
                            <div class="col-sm-10">
                                <select name="jenis_modal" id="jenis_modal" class="form-select">
                                    <option value="01">01 (Modal disetor)</option>
                                    <option value="02">02 (Modal Sumbangan)</option>
                                    <option value="03">03 (Dana setoran modal - Ekuitas)</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="hidden" class="form-control" id="id_0006" name="id_0006" value="<?= $api_hasil->id; ?>" />
                            </div>
                        </div>
                        <div class="row justify-content-end py-3">
                            <div class="col-sm-10">
                                <button type="button" id="btnEdit" onclick="edit()" class="btn btn-primary">Edit</button>
                                <a href="<?= base_url('apollo/form_report_isi_0006') ?>" class="btn btn-warning">Kembali</a>
                            </div>
                        </div>
                    </form>
...
<script>
    $(document).ready(function() {
        $('#table-res').DataTable({
            ...
            buttons: [{
                    extend: 'copyHtml5',
                    messageTop: '[LOG Edit]APOLO - Form 00.06 Paid Capital, Donated Capital, Equity',
                    exportOptions: {
        ...
        $("#jenis_modal option[value='<?= $api_hasil->jenis_modal; ?>']").prop('selected', true);
        $("#jenis_ekuitas option[value='<?= $api_hasil->jenis; ?>']").prop('selected', true);
    });
    ...
    function edit() {
        ...
        url = "<?php echo site_url('apollo/ajax_edit_0006') ?>";
