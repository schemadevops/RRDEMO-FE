                    ...
                    <form id="form">
                        <div class="row mb-3 mt-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-name">Nama Pihak
                                Terkait</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="nama_pihak_terkait" name="nama_pihak_terkait" value="<?= $api_hasil->nama_pihak_terkait; ?>" />
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-name">Alamat Pihak
                                Terkait</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="alamat_pihak_terkait" name="alamat_pihak_terkait" value="<?= $api_hasil->alamat_pihak_terkait; ?>" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-name">Jenis Pihak
                                Terkait</label>
                            <div class="col-sm-10">
                                <select name="jenis_pihak" id="jenis_pihak" class="form-select">
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-name">Hubungan
                                Pihak Terkait</label>
                            <div class="col-sm-10">
                                <select name="hubungan_pihak" id="hubungan_pihak" class="form-select">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="hidden" class="form-control" id="id_0005" name="id_0005" value="<?= $api_hasil->id; ?>" />
                            </div>
                        </div>
                        <div class="row justify-content-end py-3">
                            <div class="col-sm-10">
                                <button type="button" id="btnEdit" onclick="edit()" class="btn btn-primary">Edit</button>
                                <a href="<?= base_url('apollo/form_report_isi_0005') ?>" class="btn btn-warning">Kembali</a>
                            </div>
                        </div>
                    </form>
...
<script>
    $(document).ready(function() {
        $('#table-res').DataTable({
            ...
            buttons: [{
                    extend: 'copyHtml5',
                    messageTop: '[LOG Edit]APOLO - Form 00.05 Other Related Data',
                    exportOptions: {
    ...
    function edit() {
        ...
        url = "<?php echo site_url('apollo/ajax_edit_0005') ?>";
