                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <th scope="row"><?= $no; ?></th>
                                    <td><?= $key->jenis; ?></td>
                                    <td><?= $key->kode_kantor_kas; ?></td>
                                    <td><?= $key->sandi_kantor_induk; ?></td>
                                    <td><?= $key->sandi_kantor_cabang_sebelumnya; ?></td>
                                    <td><?= $key->nama_kantor_kas; ?></td>
                                    <td><?= $key->Latitude . ", " . $key->Longitude; ?></td>
                                    <td><?= $key->alamat; ?></td>
                                    <td><?= $key->nama_pemimpin; ?></td>
                                    <td><?= $key->no_telp; ?></td>
                                    <td><?= $key->keterangan_data_kantor_kas_dan_kegiatan_pelayanan_kas; ?></td>
                                    <td><?= date('d-m-Y', strtotime($key->tanggal_pelaksanan)); ?></td>
                                    <td><?= date('d-m-Y', strtotime($key->createdAt)); ?></td>
                                    <td>
                                        <a href="<?= base_url('apollo/form_report_edit_11/' . $key->id); ?>" class="btn rounded-pill btn-primary"><i class='bx bx-edit-alt'></i>
                                        </a>
                                    </td>
                                </tr>
                            <?php };
