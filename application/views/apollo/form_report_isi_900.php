    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            ...
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Apolo /</span>
                Form Report/ Form 09.00</h4>
            <!-- Responsive Table -->
            <div class="card">
                <h5 class="card-header">Form 09.00</h5>
                    ...
                    <table class="table table-striped table-bordered dt-responsive nowrap" id="table-res">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>T</td>
                                <td></td>
                                <td>Pendapatan Bunga yang Akan Diterima</td>
                                <td></td>
                                <td></td>
                                <td></td>
                            </tr>
                            <tr>
                                ...
                                <td>Y</td>
                                <td>001</td>
                                <td>a. Penempatan pada Bank Lain</td>
                                <td>1299010100</td>
                                <td>300000</td>
                                <td>
                                    <a href="<?= base_url('apollo/form_report_edit_900'); ?>" class="btn rounded-pill btn-primary"><i class='bx bx-edit-alt'></i>
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>Y</td>
                                <td>001</td>
                                <td>Premi penjaminan LPS dibayar dimuka</td>
                                <td>1299010100</td>
                                <td>300000</td>
                                <td>
                                    <a href="<?= base_url('apollo/form_report_edit_900'); ?>" class="btn rounded-pill btn-primary"><i class='bx bx-edit-alt'></i>
                            ...
                            <tr>
                                ...
                                <td>Y</td>
                                <td>001</td>
                                <td>Tagihan kepada perusahaan asuransi</td>
                                <td>1299010100</td>
                                <td>300000</td>
                                <td>
                                    <a href="<?= base_url('apollo/form_report_edit_900'); ?>" class="btn rounded-pill btn-primary"><i class='bx bx-edit-alt'></i>
                            ...
                            <tr>
                                ...
                                <td>Y</td>
                                <td>001</td>
                                <td>Uang Muka Untuk Kegiatan Operasional</td>
                                <td>1299010100</td>
                                <td>300000</td>
                                <td>
                                    <a href="<?= base_url('apollo/form_report_edit_900'); ?>" class="btn rounded-pill btn-primary"><i class='bx bx-edit-alt'></i>
