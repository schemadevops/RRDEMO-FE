                ...
                <div class="table-responsive text-nowrap">
                    <table class="table">
                        <tr class="text-nowrap">
                            ...
                            <th>Sandi</th>
                            <th>Nominal</th>
                            <th>Jumlah Nasahab/Rekening</th>
                            <th>Edit</th>
                        </tr>
                        <tr>
                            <th scope="row">1</th>
                            <td>Y</td>
                            <td>1. Nasabah Politically Exposed Person (PEP)/Orang yang Populer secara
                                Politis </td>
                            <td>1000</td>
                            <td>1000</td>
                            <td>10000</td>
                            <td>
                                <a href="<?= base_url('apollo/form_report_edit_14'); ?>" class="btn rounded-pill btn-primary"><i class='bx bx-edit-alt'></i>
                                </a>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">2</th>
                            <td>T</td>
                            <td>2. Jenis Nasabah Penyimpan</td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td>
                        ...
                        <tr>
                            <th scope="row">3</th>
                            <td>Y</td>
                            <td>a. Nasabah Orang Perseorangan</td>
                            <td>2100</td>
                            <td>2100</td>
                            <td>20000</td>
                            <td>
                        ...
                        <tr>
                            <th scope="row">4</th>
                            <td>Y</td>
                            <td>b. Nasabah Korporasi dan Perikatan Lainnya</td>
                            <td>3000</td>
                            <td>3000</td>
                            <td>30000</td>
                            <td>
                        ...
                        <tr>
                            <th scope="row">5</th>
                            <td>Y</td>
                            <td>Jumlah Nasabah Penyimpan</td>
                            <td>2000</td>
                            <td>2000</td>
                            <td>50000</td>
                            <td>
