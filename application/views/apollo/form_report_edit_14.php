                ...
                <div class="container mb-3">
                    <form id="form">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="jenis_nasabah" id="jenis_nasabah" class="form-select" disabled>
                                    <option value="1" selected>1. Nasabah Politically Exposed Person
                                        (PEP)/Orang
                                        yang Populer secara Politis</option>
                                    <option value="2">2. Jenis Nasabah Penyimpan</option>
                                    <option value="3">3. Komposisi Nasabah Berdasarkan Risiko</option>
                                    <option value="4">4. Jenis Simpanan</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="sandi" name="sandi" value="<?= $api_hasil->sandi; ?>" readonly />
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="jumlah_nasabah_rekening" name="jumlah_nasabah_rekening" value="<?= $api_hasil->jumlah_nasabah_rekening; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="hidden" class="form-control" id="id_0014" name="id_0014" value="<?= $api_hasil->id; ?>" />
                            </div>
                        </div>
                        <div class="row justify-content-end py-3">
                            <div class="col-sm-10">
                                <button type="button" id="btnEdit" onclick="edit()" class="btn btn-primary">Edit</button>
                                <a href="<?= base_url('apollo/form_report_isi_0014') ?>" class="btn btn-warning">Kembali</a>
                            </div>
                        </div>
                    </form>
...
<script>
    $(document).ready(function() {
        $('#table-res').DataTable({
            ...
            buttons: [{
                    extend: 'copyHtml5',
                    messageTop: '[LOG Edit]APOLO - Form 00.14 - Data Jenis Nasabah Dan Produk Simpanan di BPR',
                    exportOptions: {
    ...
    function edit() {
        ...
        url = "<?php echo site_url('apollo/ajax_edit_0014') ?>";
