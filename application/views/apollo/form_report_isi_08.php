                    ...
                    <table class="table dt-responsive" id="table-res">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <th scope="row"><?= $no; ?></th>
                                    <td><?= $key->jenis_rasio; ?></td>
                                    <td><?= $key->sandi; ?></td>
                                    <td><?= $key->nilai_rasio; ?></td>
                                    <td><?= $key->createdAt; ?></td>
                                    <td>
                                        <a href="<?= base_url('apollo/form_report_edit_08/' . $key->id); ?>" class="btn rounded-pill btn-primary"><i class='bx bx-edit-alt'></i>
                                        </a>
                                    </td>
                                </tr>
                            <?php };
...
<script>
    $(document).ready(function() {
        $('#table-res').DataTable({
            ...
            buttons: [{
                    extend: 'copyHtml5',
                    messageTop: 'APOLO - Form 00.08 Quarterly Financila Rations',
                    exportOptions: {
                        columns: [0, 1, 2, 3]
                    }
                },
