                ...
                <div class="container mb-3">
                    <form>
                        ...
                        <div class="row mb-3 mt-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="basic-default-company" value="11111" readonly />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Nama Rekening</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="basic-default-company" value="a. Penempatan pada Bank Lain" readonly />
                            </div>
                        </div>
                        <div class="row mb-3">
