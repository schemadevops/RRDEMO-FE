                    ...
                    <table class="table table-striped table-bordered dt-responsive nowrap" id="table-res">
                        <thead>
                            <tr class="text-nowrap">
                                ...
                                <th rowspan="2">Hubungan dengan gol nasabah</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $key->gol_nasabah; ?></td>
                                    <td><?= $key->lokasi_nasabah; ?></td>
                                    <td><?= $key->tgl_mulai; ?></td>
                                    <td><?= $key->tgl_jatuh_tempo; ?></td>
                                    <td><?= $key->suku_bunga; ?></td>
                                    <td><?= $key->nominal; ?></td>
                                    <td><?= $key->nominal_blokir; ?></td>
                                    <td><?= $key->alasan_blokir; ?></td>
                                    <td><?= $key->transaksi_diamortisasi; ?></td>
                                    <td><?= $key->jumlah; ?></td>
                                    <td><?= $key->createdAt; ?></td>
                                    <td>
                                        <a href="<?= base_url('apollo/form_report_edit_1200/' . $key->id); ?>" class="btn rounded-pill btn-primary"><i class='bx bx-edit-alt'></i>
                                        </a>
                                    </td>
                                </tr>
                            <?php };
...
<script>
    $(document).ready(function() {
        $('#table-res').DataTable({
            ...
            buttons: [{
                    extend: 'copyHtml5',
                    messageTop: 'APOLO - Form 12.00 - Fix Deposit List',
                    exportOptions: {
