    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            ...
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Apolo /</span>
                Form Report/ Form 00.03</h4>
            <!-- Responsive Table -->
            <div class="card">
                <h5 class="card-header">Form 00.03</h5>
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>20180101</td>
                            <td>
                                <a href="<?= base_url('apollo/form_report_edit_03'); ?>" class="btn rounded-pill btn-primary"><i class='bx bx-edit-alt'></i>
                                </a>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>Alamat 3</td>
                            <td>1234567890</td>
                            <td>02 (Pejabat Eksekutif)</td>
                            <td>00 (Tidak Menjabat)</td>
                            <td>01 (Kepala Satuan Kerja)</td>
                            <td>02 (Pejabat Eksekutif)</td>
                            <td>00 (Tidak Menjabat)</td>
                            <td>20180101</td>
                            <td>
