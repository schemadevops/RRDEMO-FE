                    ...
                    <form id="form">
                        <div class="row mb-3 mt-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-name">Jenis
                                Rasio</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="jenis_rasio" name="jenis_rasio" value="<?= $api_hasil->jenis_rasio; ?>" readonly />
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-name">Nilai Rasio
                                (%)</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="nilai_rasio" name="nilai_rasio" placeholder="John Doe" value="<?= $api_hasil->nilai_rasio; ?>" />
                            </div>
                        </div>
                        <hr>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="hidden" class="form-control" id="id_0008" name="id_0008" value="<?= $api_hasil->id; ?>" />
                            </div>
                        </div>
                        <div class="row justify-content-end py-3">
                            <div class="col-sm-10">
                                <button type="button" id="btnEdit" onclick="edit()" class="btn btn-primary">Edit</button>
                                <a href="<?= base_url('apollo/form_report_isi_0008') ?>" class="btn btn-warning">Kembali</a>
                            </div>
                        </div>
                    </form>
...
<script>
    $(document).ready(function() {
        $('#table-res').DataTable({
            ...
            buttons: [{
                    extend: 'copyHtml5',
                    messageTop: '[LOG Edit]APOLO - Form 00.08 Quarterly Financila Rations',
                    exportOptions: {
    ...
    function edit() {
        ...
        url = "<?php echo site_url('apollo/ajax_edit_0008') ?>";
