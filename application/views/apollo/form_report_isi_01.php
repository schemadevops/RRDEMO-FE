                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $key->psp; ?></td>
                                    <td><?= $key->jumlah_nominal; ?></td>
                                    <td><?= $key->persentase_kepemilikan; ?></td>
                                    <td>
                                        <a href="<?= base_url('apollo/form_report_edit_01/' . $key->id); ?>" class="btn rounded-pill btn-primary"><i class='bx bx-edit-alt'></i>
                                        </a>
                                    </td>
                                </tr>
                            <?php };
...
<script>
    $(document).ready(function() {
        $('#table-res').DataTable({
            ...
            buttons: [{
                    extend: 'copyHtml5',
                    messageTop: 'APOLO - Form 00.01 BPR Ownership Data',
                    exportOptions: {
