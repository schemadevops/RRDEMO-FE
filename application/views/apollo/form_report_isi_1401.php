                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $key->uraian; ?></td>
                                    <td><?= $key->jumlah; ?></td>
                                    <td><?= date('d-m-Y', strtotime($key->jumlah)); ?></td>
                                    <td>
                                        <a href="<?= base_url('apollo/form_report_edit_1401/' . $key->id); ?>" class="btn rounded-pill btn-primary"><i class='bx bx-edit-alt'></i>
                                        </a>
                                    </td>
                                </tr>
                            <?php };
...
<script>
    $(document).ready(function() {
        $('#table-res').DataTable({
            ...
            buttons: [{
                    extend: 'copyHtml5',
                    messageTop: 'APOLO - 14.01 - Details of Other Liability - Others',
                    exportOptions: {
                        columns: [0, 1, 2, 3]
                    }
                },
