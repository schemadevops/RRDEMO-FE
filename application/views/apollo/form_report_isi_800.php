                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $key->stts_asset; ?></td>
                                    <td><?= $key->biaya_perolehan; ?></td>
                                    <td><?= $key->akumulasi_penyusutan; ?></td>
                                    <td><?= $key->akumulasi_penurunan; ?></td>
                                    <td><?= $key->nilai_tercatat; ?></td>
                                    <td><?= date('d-m-Y', strtotime($key->createdAt)); ?></td>
                                    <td>
                                        <a href="<?= base_url('apollo/form_report_edit_800/' . $key->id); ?>" class="btn rounded-pill btn-primary"><i class='bx bx-edit-alt'></i>
                                        </a>
                                    </td>
                                </tr>
                            <?php };
