                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <th scope="row"><?= $no; ?></th>
                                    <td><?= $key->jenis; ?></td>
                                    <td><?= $key->tanggal_persetujuan_ojk; ?></td>
                                    <td><?= $key->jenis_modal; ?></td>
                                    <td><?= $key->jumlah; ?></td>
                                    <td><?= date('d-m-Y', strtotime($key->createdAt)); ?></td>
                                    <td>
                                        <a href="<?= base_url('apollo/form_report_edit_06/' . $key->id); ?>" class="btn rounded-pill btn-primary"><i class='bx bx-edit-alt'></i>
                                        </a>
                                    </td>
                                </tr>
                            <?php };
...
<script>
    $(document).ready(function() {
        $('#table-res').DataTable({
            ...
            buttons: [{
                    extend: 'copyHtml5',
                    messageTop: 'APOLO - Form 00.06 Paid Capital, Donated Capital, Equity',
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4]
                    }
                },
