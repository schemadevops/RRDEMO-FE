                    ...
                    <table class="table dt-responsive" id="table-res">
                        <thead>
                            <tr class="text-nowrap">
                                ...
                                <th rowspan="2">Membawahkan Fungsi Kepatuhan (Ya/Tidak)</th>
                                <th rowspan="2">Komisaris Independen (Ya/Tidak)</th>
                                <th rowspan="2">Keterangan Penyebab Berhenti Menjabat</th>
                                <th rowspan="2">Tanggal Berhenti Menjabat </th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $key->komite_pemantau_risiko; ?></td>
                                    <td><?= $key->komite_remunerasi_dan_nominasi; ?></td>
                                    <td><?= $key->membawahkan_fungsi_kepatuhan; ?></td>
                                    <td><?= $key->komisaris_independen; ?></td>
                                    <td><?= $key->keterangan_penyebab_berhenti_menjabat; ?></td>
                                    <td><?= date('d-m-Y', strtotime($key->tanggal_berhenti_menjabat)); ?></td>
                                    <td><?= $key->alasan_mengundurkan_diri; ?></td>
                                    <td><?= date('d-m-Y', strtotime($key->createdAt)); ?></td>
                                    <td>
                                        <a href="<?= base_url('apollo/form_report_edit_09/' . $key->id); ?>" class="btn rounded-pill btn-primary"><i class='bx bx-edit-alt'></i>
                                        </a>
                                    </td>
                                </tr>
                            <?php };
...
<?php $this->view('temp/footer'); ?><script src="https://cdn.datatables.net/buttons/2.4.1/js/dataTables.buttons.min.js"></script>
...
<script>
    $(document).ready(function() {
        $('#table-res').DataTable({
            ...
            buttons: [{
                    extend: 'copyHtml5',
                    messageTop: 'APOLO - Form 00.09 Data BoD/BoC Who Have Stopped Serving',
                    exportOptions: {
