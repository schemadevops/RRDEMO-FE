...
class Apollo extends CI_Controller
{
	...
	public function report_process()
	{
		...
		$this->load->view('apollo/report_process', $data);
	}
	...
	public function backup_restore()
	{
		...
		$this->load->view('temp/sidebar');
		$this->load->view('temp/navbar');
		$this->load->view('apollo/backup_restore', $data);
	}
	...
	public function form_report_isi_0101()
	{
		...
		if ($tgl_seacrh != "") {
			...
			curl_setopt_array($curl, array(
				CURLOPT_URL => 'http://141.136.47.149:3003/apolo/form0101/getbydate',
				CURLOPT_RETURNTRANSFER => true,
				CURLOPT_ENCODING => '',
				CURLOPT_MAXREDIRS => 10,
				CURLOPT_TIMEOUT => 0,
			...
			curl_setopt_array($curl, array(
				CURLOPT_URL => 'http://141.136.47.149:3003/apolo/form0101',
				CURLOPT_RETURNTRANSFER => true,
				CURLOPT_ENCODING => '',
				CURLOPT_MAXREDIRS => 10,
				CURLOPT_TIMEOUT => 0,
		...
		$newdata = array(
			'data_export_txt'  => $data['api_hasil'],
			'kode_form'		=> '01.01',
			'nama_form'		=> 'Form 01.01 - Off Belance Sheet'
		);
		$this->session->set_userdata($newdata);

		$data['api_hasil'] = $hasil;
		$data['header'] = 'Form 01.01 - Off Belance Sheet';
		$this->load->view('temp/head');
		$this->load->view('temp/sidebar');
		$this->load->view('temp/navbar');
		$this->load->view('apollo/form_report_isi_101', $data);
	}

	public function form_report_edit_101($id)
	{
		$curl = curl_init();

		curl_setopt_array($curl, array(
			CURLOPT_URL => 'http://141.136.47.149:3003/apolo/form0101/' . $id,
			CURLOPT_RETURNTRANSFER => true,
			CURLOPT_ENCODING => '',
			CURLOPT_MAXREDIRS => 10,
			CURLOPT_TIMEOUT => 0,
		...
		$data['header'] = "Apolo Form 01.01 - Off Belance Sheet";
		$this->load->view('temp/head');
		$this->load->view('temp/sidebar');
		$this->load->view('temp/navbar');
		$this->load->view('apollo/form_report_edit_101', $data);
	}



	public function form_report_isi_0200()
	{
		$this->load->view('temp/head');
		$this->load->view('temp/sidebar');
		$this->load->view('temp/navbar');
		$this->load->view('apollo/form_report_isi_200');
	}
	...
	public function form_report_isi_0400()
	{
		...
		if ($tgl_seacrh != "") {
			...
			curl_setopt_array($curl, array(
				CURLOPT_URL => 'http://141.136.47.149:3003/apolo/form0400/getbydate',
				CURLOPT_RETURNTRANSFER => true,
				CURLOPT_ENCODING => '',
				CURLOPT_MAXREDIRS => 10,
				CURLOPT_TIMEOUT => 0,
			...
			curl_setopt_array($curl, array(
				CURLOPT_URL => 'http://141.136.47.149:3003/apolo/form0400',
				CURLOPT_RETURNTRANSFER => true,
				CURLOPT_ENCODING => '',
				CURLOPT_MAXREDIRS => 10,
				CURLOPT_TIMEOUT => 0,
		...
		$newdata = array(
			'data_export_txt'  => $data['api_hasil'],
			'kode_form'		=> '04.00',
			'nama_form'		=> 'Form 04.00 - List of Securities'
		);
		$this->session->set_userdata($newdata);

		$data['api_hasil'] = $hasil;
		$data['header'] = 'Form 04.00 - List of Securities';
		$this->load->view('temp/head');
		$this->load->view('temp/sidebar');
		$this->load->view('temp/navbar');
		$this->load->view('apollo/form_report_isi_400', $data);
	}

	public function form_report_edit_400($id)
	{
		$curl = curl_init();

		curl_setopt_array($curl, array(
			CURLOPT_URL => 'http://141.136.47.149:3003/apolo/form0400/' . $id,
			CURLOPT_RETURNTRANSFER => true,
			CURLOPT_ENCODING => '',
			CURLOPT_MAXREDIRS => 10,
			CURLOPT_TIMEOUT => 0,
		...
		$data['header'] = "Apolo Form 04.00 - List of Securities";

		$this->load->view('temp/head');
		$this->load->view('temp/sidebar');
		$this->load->view('temp/navbar');
		$this->load->view('apollo/form_report_edit_400', $data);
	}

	public function ajax_edit_0400()
	{
		$id_0400 = $this->input->post('id_0400');
		$sandi_kantor = $this->input->post('sandi_kantor');
		...
		$biaya_perolehan_diamortisasi = $this->input->post('biaya_perolehan_diamortisasi');
		$alasan_edit = $this->input->post('alasan_edit');

		$curl = curl_init();

		curl_setopt_array($curl, array(
			CURLOPT_URL => 'http://141.136.47.149:3003/apolo/form0400/' . $id_0400,
			CURLOPT_RETURNTRANSFER => true,
			CURLOPT_ENCODING => '',
			CURLOPT_MAXREDIRS => 10,
			CURLOPT_TIMEOUT => 0,
			...
			CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
			CURLOPT_CUSTOMREQUEST => 'PUT',
			CURLOPT_POSTFIELDS => 'sandi_kantor=' . $sandi_kantor . '&klasifikasi=' . $klasifikasi . '&suku_bunga=' . $suku_bunga . '&tgl_mulai=' . $tgl_mulai . '&tgl_jatuh_tempo=' . $tgl_jatuh_tempo . '&nominal=' . $nominal . '&nominal_dijaminkan=' . $nominal_dijaminkan . '&biaya_perolehan=' . $biaya_perolehan . '&diskonto_belum_diamortisasi=' . $diskonto_belum_diamortisasi . '&biaya_transaksi_diamortisasi=' . $biaya_transaksi_diamortisasi . '&laba_rugi=' . $laba_rugi . '&biaya_perolehan_diamortisasi=' . $biaya_perolehan_diamortisasi . '&alasan=' . $alasan_edit,
			CURLOPT_HTTPHEADER => array(
				'Content-Type: application/x-www-form-urlencoded',
				'Authorization: Bearer ' . $this->session->access_token
			),
	...
	public function form_report_isi_0601()
	{
		...
		if ($tgl_seacrh != "") {
			...
			curl_setopt_array($curl, array(
				CURLOPT_URL => 'http://141.136.47.149:3003/apolo/form0601/getbydate',
				CURLOPT_RETURNTRANSFER => true,
				CURLOPT_ENCODING => '',
				CURLOPT_MAXREDIRS => 10,
				CURLOPT_TIMEOUT => 0,
			...
			curl_setopt_array($curl, array(
				CURLOPT_URL => 'http://141.136.47.149:3003/apolo/form0601',
				CURLOPT_RETURNTRANSFER => true,
				CURLOPT_ENCODING => '',
				CURLOPT_MAXREDIRS => 10,
				CURLOPT_TIMEOUT => 0,
		...
		$newdata = array(
			'data_export_txt'  => $data['api_hasil'],
			'kode_form'		=> '06.01',
			'nama_form'		=> 'Form 06.01 - Collateral List'
		);
		$this->session->set_userdata($newdata);

		$data['api_hasil'] = $hasil;
		$data['header'] = 'Form 06.01 - Collateral List';
		$this->load->view('temp/head');
		$this->load->view('temp/sidebar');
		$this->load->view('temp/navbar');
	...
	public function form_report_isi_0700()
	{
		...
		if ($tgl_seacrh != "") {
			...
			curl_setopt_array($curl, array(
				CURLOPT_URL => 'http://141.136.47.149:3003/apolo/form0700/getbydate',
				CURLOPT_RETURNTRANSFER => true,
				CURLOPT_ENCODING => '',
				CURLOPT_MAXREDIRS => 10,
				CURLOPT_TIMEOUT => 0,
			...
			curl_setopt_array($curl, array(
				CURLOPT_URL => 'http://141.136.47.149:3003/apolo/form0700',
				CURLOPT_RETURNTRANSFER => true,
				CURLOPT_ENCODING => '',
				CURLOPT_MAXREDIRS => 10,
				CURLOPT_TIMEOUT => 0,
		...
		$newdata = array(
			'data_export_txt'  => $data['api_hasil'],
			'kode_form'		=> '07.00',
			'nama_form'		=> 'Form 07.00 - List of Collatetal That Has Overtaken by BPR'
		);
		$this->session->set_userdata($newdata);

		$data['api_hasil'] = $hasil;
		$data['header'] = 'Form 07.00 - List of Collatetal That Has Overtaken by BPR';
		$this->load->view('temp/head');
		$this->load->view('temp/sidebar');
		$this->load->view('temp/navbar');
		$this->load->view('apollo/form_report_isi_700', $data);
	}

	public function form_report_edit_700($id)
	{
		$curl = curl_init();

		curl_setopt_array($curl, array(
			CURLOPT_URL => 'http://141.136.47.149:3003/apolo/form0700/' . $id,
			CURLOPT_RETURNTRANSFER => true,
			CURLOPT_ENCODING => '',
			CURLOPT_MAXREDIRS => 10,
			CURLOPT_TIMEOUT => 0,
		...
		$data['header'] = "Apolo Form 07.00 - List of Collatetal That Has Overtaken by BPR";
		$this->load->view('temp/head');
		$this->load->view('temp/sidebar');
		$this->load->view('temp/navbar');
		$this->load->view('apollo/form_report_edit_700', $data);
	}

	public function ajax_edit_0700()
	{
		$id_0700 = $this->input->post('id_0700');
		$sandi_kantor = $this->input->post('sandi_kantor');
		$jenis_agunan = $this->input->post('jenis_agunan');
		$alamat_agunan = $this->input->post('alamat_agunan');
		$tgl_pengambialihan = $this->input->post('tgl_pengambialihan');
		$nilai_pengakuan_awal = $this->input->post('nilai_pengakuan_awal');
		$akumulasi_keruguan = $this->input->post('akumulasi_keruguan');
		$jumlah = $this->input->post('jumlah');
		$alasan_edit = $this->input->post('alasan_edit');
		...
		curl_setopt_array($curl, array(
			CURLOPT_URL => 'http://141.136.47.149:3003/apolo/form0700/' . $id_0700,
			CURLOPT_RETURNTRANSFER => true,
			CURLOPT_ENCODING => '',
			CURLOPT_MAXREDIRS => 10,
			CURLOPT_TIMEOUT => 0,
			...
			CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
			CURLOPT_CUSTOMREQUEST => 'PUT',
			CURLOPT_POSTFIELDS => 'sandi_kantor=' . $sandi_kantor . '&jenis_agunan=' . $jenis_agunan . '&alamat_agunan=' . $alamat_agunan . '&tgl_pengambialihan=' . $tgl_pengambialihan . '&nilai_pengakuan_awal=' . $nilai_pengakuan_awal . '&akumulasi_keruguan=' . $akumulasi_keruguan . '&jumlah=' . $jumlah . '&alasan=' . $alasan_edit,
			CURLOPT_HTTPHEADER => array(
				'Content-Type: application/x-www-form-urlencoded',
				'Authorization: Bearer ' . $this->session->access_token
			),
	...
	public function form_report_isi_0800()
	{
		...
		$newdata = array(
			'data_export_txt'  => $data['api_hasil'],
			'kode_form'		=> '08.00',
			'nama_form'		=> 'Form 08.00 - List of Fixed Assets, Inventory and Intanible Assets'
		);
		$this->session->set_userdata($newdata);

		$data['api_hasil'] = $hasil;
		$data['header'] = 'Form 08.00 - List of Fixed Assets, Inventory and Intanible Assets';
		$this->load->view('temp/head');
		$this->load->view('temp/sidebar');
		$this->load->view('temp/navbar');
